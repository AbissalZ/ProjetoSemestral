...
public class PainelHospedagem extends javax.swing.JFrame {
    ...
    public void preencherTabela(){
        DefaultTableModel model = (DefaultTableModel) tabelaHospedagens.getModel();
        List<Hospedagem> lista = new HospedagemDAO().findAll();
        Object linha[] = new Object[5];
        for(int i=0;i<lista.size();i++){
            linha[0]=lista.get(i).getNrDeHospedagem();
            linha[1]=lista.get(i).getDataEntrada();
            linha[2]=lista.get(i).getDataSaida();
            linha[3]=lista.get(i).getQuarto().getNumeroQuarto()+" Id: "+lista.get(i).getQuarto().getIdQuarto();
            
            if(lista.get(i).getHospede()!=null){
                linha[4]=lista.get(i).getHospede().getNome()+" "+lista.get(i).getHospede().getApelido();
            }else{
                linha[4]=lista.get(i).getHospede().getNome()+" "+lista.get(i).getHospede().getApelido();
            }
            model.addRow(linha);
    ...
    private void initComponents() {
        ...
        tabelaHospedagens.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod da Hospedagem", "Data de Entrada", "Data de Saida", "Quarto", "Hospede"
            }
        ) {
