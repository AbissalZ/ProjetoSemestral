 ...
 * @author Zita_Office
 */
public class PainelUsuarios extends javax.swing.JFrame {
    ...
    public void preencherTabela(){
        ...
        for(int i=0;i<lista.size();i++){
            ...
            linha[1]=lista.get(i).getUserName();
            linha[2]=lista.get(i).getPassWord();
            linha[3]=lista.get(i).getNivelAcesso();
            model.addRow(linha);
        }
    }
    ...
    private void initComponents() {
        ...
        TabelaUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id do Usuario", "Nome de Usuario", "Password", "Nivel de Acesso"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PainelUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
